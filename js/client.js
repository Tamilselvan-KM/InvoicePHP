...
var clientRegisterForm = document.querySelector('#clientRegisterForm'),
...
function validateclientRegister() {
    ...
    if (!isError) {
        ...
        xhttp.open('POST', 'includes/clientReg.php', false);
